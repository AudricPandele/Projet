...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 24 Avril 2015 à 10:27
...
INSERT INTO `contrat` (`id`, `titre`, `fournisseur`, `client`, `tache`, `description`, `prix_global`, `date`) VALUES
(1, 'titre', 0, 0, 0, '', 200, '2015-03-27'),
(2, 'test', 1, 1, 1, 'test', 16, '24-04-15'),
(3, 'test2', 2, 2, 1, 'test', 5, '24-04-15');
...
(2, 'test', 'test', 'test', 661386327),
(3, 'test', 'test', 'test', 661386327);
...
(2, 'Charbonier', 'Louis', 20, 'louis', 'louis'),
(3, 'test', 'test', 20, 'test', 'test');
